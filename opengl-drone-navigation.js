...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'opengl-drone-navigation.data';
      var REMOTE_PACKAGE_BASE = 'opengl-drone-navigation.data';
...
Module['FS_createPath']("/src", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_opengl-drone-navigation.data');

      };
      Module['addRunDependency']('datafile_opengl-drone-navigation.data');
    ...
    loadPackage({"files": [{"filename": "/src/shaders/sprite.vs", "start": 0, "end": 268}, {"filename": "/src/shaders/sprite.frag", "start": 268, "end": 460}], "remote_package_size": 460, "package_uuid": "0687a0f7-8cd3-4430-8244-b9015be02ee5"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'opengl-drone-navigation.wasm';
